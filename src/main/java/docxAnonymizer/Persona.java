...
public class Persona implements Serializable {
	...
	private Optional<String> plainName;
	...
	public Persona(String cognome, List<String> nomi, int id) {
		...
		// Get plain name
		if (nomi.size() > 0)
			this.plainName = Optional.of(nomi.get(0));
		else
			this.plainName = Optional.empty();
	...
	public Persona(String nome, int id) {
		...
		// Get plain name
		this.plainName = Optional.of(nome);
